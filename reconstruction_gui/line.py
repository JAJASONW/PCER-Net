...
if __name__=='__main__':
    ...
    for fn in fns:
        ...
        l_residuals, z0, z1, line_points = fit_xyz_yzx_xzy(np.array(cloud))
        print(l_residuals, z0, z1, line_points)
        print(line_points.shape)
        np.savetxt(save_dir + fn + "_linefit.txt", line_points, fmt="%.5f")
